window.lang = {
    ...
    "es": {
        ...
        "services5_text": "Nuestro objetivo en cuanto a desarrollo de paginas Web es que nuestros clientes estén orgullosos de su página Web ( La mayoría lo están!) Sabemos de diseño y constantemente nos documentamos de las nuevas tendencias europeas y norteamericanas para ofrecerte lo mejor de cada mundo. Pero también entendemos que el gusto es subjetivo y tenemos la capacidad de interpretar lo que nuestros clientes necesitan. Si revisa nuestro portafolio se dará cuenta que en cada diseño se encuentra plasmado el espíritu de cada negocio.",
        "services6_title": "Aplicaciones Mobiles",
        "services6_text": "Nuestros desarrollos moviles combinan aplicaciones funcionales como administradores de contenidos de uso intuitivo que no requieren de parte del usuario ningún conocimiento más allá de saber navegar por internet. Estamos en capacidad de ayudarle en todas sus necesidades moviles por más complejas que parezcan.",
